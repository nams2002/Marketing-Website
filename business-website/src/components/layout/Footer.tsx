...
export default function Footer() {
  return (
    <footer className="bg-gradient-modern border-t border-gray-800">
      <div className="container-max py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 text-white">{businessInfo.name}</h3>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gray-700 rounded-2xl flex items-center justify-center text-gray-300 hover:bg-indigo-600 hover:text-white transition-all duration-200"
                aria-label="Facebook"
              >
