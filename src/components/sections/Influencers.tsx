      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {businessInfo.influencers.map((influencer) => (
            <div
              key={influencer.id}
              className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
              {/* Profile Header */}
              <div className="text-center mb-6">
                <div className="w-20 h-20 rounded-full overflow-hidden mx-auto mb-4 border-2 border-gradient-to-br from-blue-500 to-purple-600">
                  <Image
                ...
                <div className="inline-block bg-blue-600/20 text-blue-400 text-xs font-semibold px-3 py-1 rounded-full">
                  {influencer.category}
                </div>
              </div>
              ...
              <div className="flex space-x-3">
                ...
                <button className="flex-1 border-2 border-blue-400 text-blue-400 py-2 px-4 rounded-lg font-medium hover:bg-blue-400 hover:text-black transition-colors duration-200">
                  Collaborate
                </button>
              </div>
            </div>
