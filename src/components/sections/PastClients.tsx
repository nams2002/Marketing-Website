        ...
        >
          {businessInfo.pastClients.map((client) => (
            <motion.div
              ...
              className="group bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:border-blue-400 overflow-hidden relative"
            >
              ...
              <div className="text-center mb-4">
                ...
                <div className="text-sm text-blue-400 font-medium">{client.industry}</div>
              </div>
